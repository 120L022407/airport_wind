...
LAUNCH_TAG="${LAUNCH_TAG:-15min_cube}"
...
BASELINE_CONFIGS=(
  "config/gru/baseline_15min_cube.yaml"
  "config/patchtst/baseline_15min_cube.yaml"
  "config/itransformer/baseline_15min_cube.yaml"
  "config/dlinear/baseline_15min_cube.yaml"
  "config/tfps/baseline_15min_cube.yaml"
  "config/timebridge/baseline_15min_cube.yaml"
  "config/hcan/baseline_15min_cube.yaml"
)
...
echo "Example: tail -f ${LAUNCH_DIR}/gru_baseline_15min_cube.log"
